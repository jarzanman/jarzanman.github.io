...
site_title=${_1600PR_SITE_TITLE:-"photos"} # <title> in HTML and RSS
...
image_dir=${_1600PR_IMAGE_DIR:-"./assets/photos"}    # Directory where original images should be stored
output_dir=${_1600PR_OUTPUT_DIR:-"."}  # Where to build the site

default_menu="<a href=\"${web_root_path}photo\">archive</a>"
